// Adapted from reactbits.dev (DavidHDev/react-bits) — Backgrounds/Grainient.
// WindowChrome uses it as a passive ambient layer, so it intentionally
// exposes color/motion props but does not attach pointer interaction.
